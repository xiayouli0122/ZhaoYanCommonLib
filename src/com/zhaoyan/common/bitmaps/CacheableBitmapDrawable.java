...
public class CacheableBitmapDrawable extends BitmapDrawable {
    ...
    private static final String LOG = CacheableBitmapDrawable.class.getSimpleName();
    ...
    private void cancelCheckStateCallback() {
        if (null != mCheckStateRunnable) {
            Log.d(LOG, "Cancelling checkState() callback for: " + mUrl);
